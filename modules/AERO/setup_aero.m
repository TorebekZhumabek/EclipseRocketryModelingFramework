...
switch instruct
    ...
    case 'create'
        ...
        % General
        AERO.AF_1.LENGTH = 37; % IN
        AERO.AF_1.OUTER_DIAM = 6.155; % IN
        AERO.AF_1.INNER_DIAM = 6.007; % IN
        AERO.AF_1.WALL_THICKNESS = 0.074; % IN
        AERO.AF_1.DENSITY = 0.123; % LBM/IN^3
        AERO.AF_1.X_LE = 24; 
        AERO.AF_1.X_TE = AERO.AF_1.X_LE+ AERO.AF_1.LENGTH;
        
        %% AIRFRAME 2 - MOTOR FRAME
        % General
        AERO.AF_2.LENGTH = 48; % IN
        AERO.AF_2.OUTER_DIAM = 6.155; % IN
        AERO.AF_2.INNER_DIAM = 6.007; % IN
        AERO.AF_2.WALL_THICKNESS = 0.074; % IN
        AERO.AF_2.DENSITY = 0.123; % LBM/IN^3
        AERO.AF_2.X_LE = AERO.AF_1.X_TE; 
        AERO.AF_2.X_TE = AERO.AF_1.X_LE+ AERO.AF_1.LENGTH;

        %% FIN SET
        % General
        AERO.FIN.BODY_DIAM = 6.15;
        AERO.FIN.LEAD_EDGE = 94;
        AERO.FIN.COUNT = 4;
    ...
    case 'update'
        ...
        %% AIRFRAME 1 - PAYLOAD FRAME        
        % CP CALC
        AERO.AF_1.AREA_LE = AERO.AF_1.OUTER_DIAM ^2 * 0.25 * pi;
        AERO.AF_1.AREA_TE = AERO.AF_1.AREA_LE;
        AERO.AF_1.XVALS = [AERO.AF_1.X_LE, AERO.AF_1.X_TE];
        AERO.AF_1.YVALS = [AERO.AF_1.OUTER_DIAM, AERO.AF_1.OUTER_DIAM];
        
        AERO.AF_1.AREA_PLANAR = AERO.AF_1.OUTER_DIAM * AERO.AF_1.LENGTH;
        AERO.AF_1.X_CP = AERO.AF_1.LENGTH^2 * AERO.AF_1.OUTER_DIAM*0.5 / AERO.AF_1.AREA_PLANAR;
        AERO.AF_1.BODY_RADIUS_AVG = 0.5*(AERO.NC.AREA_PLAN + AERO.AF_1.AREA_PLANAR) / (AERO.NC.X_TE + AERO.AF_1.LENGTH);
        AERO.AF_1.BODY_AREA_WET = AERO.NC.AREA_WET + pi*AERO.AF_1.OUTER_DIAM*AERO.AF_1.LENGTH;
        
        % DRAG
        
        % MASS AND MOMENT OF INERTIA
        AERO.AF_1.MASS = 6.43; %LBM
        AERO.AF_1.CG = AERO.AF_1.LENGTH *0.5 + AERO.AF_1.X_LE;
        AERO.AF_1.INERTIA_TENSOR = [ %lbm * in^2
            28.00259,    0.00,	0.00;...
       ...
       %% AIRFRAME 2 - PAYLOAD FRAME        
        % CP CALC
        AERO.AF_2.AREA_LE = AERO.AF_2.OUTER_DIAM ^2 * 0.25 * pi;
        AERO.AF_2.AREA_TE = AERO.AF_2.AREA_LE;
        AERO.AF_2.XVALS = [AERO.AF_2.X_LE, AERO.AF_2.X_TE];
        AERO.AF_2.YVALS = [AERO.AF_2.OUTER_DIAM, AERO.AF_2.OUTER_DIAM];
        
        AERO.AF_2.AREA_PLANAR = AERO.AF_2.OUTER_DIAM * AERO.AF_2.LENGTH;
        AERO.AF_2.X_CP = AERO.AF_2.LENGTH^2 * AERO.AF_2.OUTER_DIAM*0.5 / AERO.AF_2.AREA_PLANAR;
        AERO.AF_2.BODY_RADIUS_AVG = 0.5*AERO.AF_2.OUTER_DIAM;%(AERO.NC.AREA_PLAN + AERO.AF_2.AREA_PLANAR) / (AERO.NC.TRAIL_EDGE + AERO.AF_2.LENGTH);
%         AERO.AF_2.BODY_AREA_WET = AERO.NC.AREA_WET + pi*AERO.AF_2.BODY_DIAM*AERO.AF_2.LENGTH;
        
        % DRAG
        
        % MASS AND MOMENT OF INERTIA
        AERO.AF_2.MASS = 6.43; %LBM
        AERO.AF_2.CG = AERO.AF_2.LENGTH *0.5 + AERO.AF_2.X_LE;
        AERO.AF_2.INERTIA_TENSOR = [ %lbm * in^2
            28.00259,    0.00,	0.00;...
            0.00,   5834.79129,  0.00;...
            0.00,   0.00,   5834.79129];
...
%         AERO.NC.X_CP = BODY_CP_CALC(LENGTH, TRAIL_EDGE_AREA, VOL, LEAD_EDGE_AREA);
    ...
    function FIN_CP_CALC(type)
        switch type
            case 'Trapezoid'
               ...
               AERO.FIN.AREA = 0.5 * (AERO.FIN.C_ROOT + AERO.FIN.C_TIP) * AERO.FIN.SPAN;
